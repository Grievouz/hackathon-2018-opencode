...
const react_dom_1 = __webpack_require__(11);
const app_1 = __webpack_require__(31);
...
react_dom_1.render(React.createElement(app_1.default, null), document.getElementById("injected-div"));
...
*/
var aa=__webpack_require__(1),l=__webpack_require__(12),B=__webpack_require__(3),C=__webpack_require__(2),ba=__webpack_require__(13),da=__webpack_require__(14),ea=__webpack_require__(15),fa=__webpack_require__(16),ia=__webpack_require__(17),D=__webpack_require__(4);
...
const sidebar_2 = __webpack_require__(42);
const threshold_1 = __webpack_require__(43);
const mobx_react_1 = __webpack_require__(7);
let App = class App extends React.Component {
    render() {
        return (React.createElement("div", { id: "injected-app" },
            React.createElement(threshold_1.default, { store: sidebar_2.default }),
            React.createElement(sidebar_1.default, { store: sidebar_2.default })));
    }
};
App = __decorate([
...
// module
exports.push([module.i, "#injected-app * {\n    z-index: 100000;\n}\n\n\n", ""]);
...
const React = __webpack_require__(1);
const mobx_react_1 = __webpack_require__(7);
const contentCard_1 = __webpack_require__(39);
let Sidebar = class Sidebar extends React.Component {
    constructor(props) {
        ...
        this.state = {
            cards: [
                React.createElement(contentCard_1.default, null),
                React.createElement(contentCard_1.default, null)
            ]
        };
        window.addEventListener("click", (event) => {
            if (!document.getElementById("injected-sidebar").contains(event.target)) {
                this.props.store.visible = false;
            }
        });
    }
    render() {
        return (React.createElement("div", { id: "injected-sidebar", className: this.props.store.visible ? "opened" : "closed" }, this.state.cards));
    }
};
Sidebar = __decorate([
    mobx_react_1.observer
...
// module
exports.push([module.i, "#injected-app > #injected-sidebar {\n    width: 450px !important;\n    height: 100vh !important;\n    position: fixed;\n    right: 0 !important;\n    top: 0 !important;\n\n    overflow-x: hidden;\n\n    background: url(https://i.pinimg.com/originals/4a/99/c9/4a99c9fb897e7ae4b4f43806955d7576.png);\n    background-size: cover;\n    box-shadow: -5px 0px 20px 1px rgba(0, 0, 0, 0.69);\n\n    display: flex;\n    flex-wrap: wrap;\n    align-content: flex-start;\n\n    transition: transform 0.3s ease-in-out;\n}\n\n#injected-app > #injected-sidebar.opened {\n    transform: translate(0, 0);\n}\n\n#injected-app > #injected-sidebar.closed {\n    transform: translate(500px, 0);\n}\n#injected-app > #injected-sidebar::-webkit-scrollbar {\n    width: 10px;\n    background: transparent;\n}\n\n#injected-app > #injected-sidebar::-webkit-scrollbar-thumb {\n    border-radius: 10px;\n    background-color: #d9d9d9;\n}\n\n#injected-app > #injected-sidebar::-webkit-scrollbar-thumb:hover {\n    background-color: white;\n}\n\n\n\n", ""]);
...
const React = __webpack_require__(1);
const mobx_react_1 = __webpack_require__(7);
let ContentCard = class ContentCard extends React.Component {
    render() {
        return (React.createElement("div", { className: "contentCardContainer" },
            React.createElement("div", { className: "contentCard" },
                React.createElement("div", { className: "header" },
                    React.createElement("div", { className: "headerIconContainer" },
                        React.createElement("img", { className: "headerIcon", src: "https://cdn.sstatic.net/Sites/stackoverflow/img/favicon.ico" })),
                    React.createElement("div", { className: "headerHeadline" }, "Stackoverflow"),
                    React.createElement("div", { className: "headerExtra" }, "30min")),
...
if(false) {
	module.hot.accept("!!../../node_modules/css-loader/index.js!./contentCard.css", function() {
		var newContent = require("!!../../node_modules/css-loader/index.js!./contentCard.css");
...
// module
exports.push([module.i, ":root{\r\n    --padding: 10px;\r\n    --height: 200px;\r\n\r\n    --headlineFont: \"Roboto\", sans-serif;\r\n    --extraFont: \"Roboto\", sans-serif;\r\n    --bodyFont: \"Roboto\", sans-serif;\r\n}\r\n\r\n#injected-div  .contentCardContainer{\r\n    width: calc(100% - var(--padding) * 2);\r\n    height: var(--height);\r\n    padding-top: calc(var(--padding)/2);\r\n    padding-bottom: calc(var(--padding)/2);\r\n    padding-left: var(--padding);\r\n    padding-right: var(--padding);\r\n\r\n\r\n    color: #212529;\r\n}\r\n\r\n#injected-div .contentCardContainer > .contentCard{\r\n    width: 100%;\r\n    height: 100%;\r\n    background: rgba(255, 255, 255, 0.44);\r\n    border-radius: 10px;\r\n    overflow: hidden;\r\n\r\n    transition: all 0.1s ease-in-out;\r\n}\r\n\r\n#injected-div .contentCardContainer > .contentCard:hover{\r\n    transform: scale(1.02);\r\n}\r\n\r\n#injected-div .contentCardContainer > .contentCard > .header{\r\n    width: 100%;\r\n    height: 30px;\r\n    background: rgba(255, 255, 255, 0.6);\r\n\r\n}\r\n\r\n#injected-div .contentCardContainer > .contentCard > .header > .headerIconContainer{\r\n    width: 40px;\r\n    height: 30px;\r\n\r\n    overflow: hidden;\r\n    float: left;\r\n\r\n    display: flex;\r\n    justify-content: center;\r\n    align-items: center;\r\n}\r\n\r\n#injected-div .contentCardContainer > .contentCard > .header > .headerIconContainer > .headerIcon{\r\n    height: 90%;\r\n}\r\n\r\n#injected-div .contentCardContainer > .contentCard > .header > .headerHeadline{\r\n    float: left;\r\n    height: 30px;\r\n\r\n    font-family: var(--headlineFont);\r\n    font-weight: 500;\r\n\r\n    display: flex;\r\n    justify-content: flex-start;\r\n    align-items: center;\r\n}\r\n\r\n#injected-div .contentCardContainer > .contentCard > .header > .headerExtra{\r\n    float: right;\r\n    margin-right: 5px;\r\n    height: 30px;\r\n\r\n    display: flex;\r\n    justify-content: flex-end;\r\n    align-items: center;\r\n\r\n    font-family: var(--extraFont);\r\n    font-weight: 300;\r\n}", ""]);
...
Object.defineProperty(exports, "__esModule", { value: true });
const mobx_1 = __webpack_require__(18);
class SidebarStore {
    constructor() {
        this.visible = false;
    }
...
const React = __webpack_require__(1);
const mobx_react_1 = __webpack_require__(7);
let Threshold = class Threshold extends React.Component {
    constructor() {
        super(...arguments);
    ...
    render() {
        return (React.createElement("div", { id: "injected-threshold", onMouseEnter: (event) => this.handleOnMouseEnter(), onMouseLeave: () => this.mouseOver = false }));
    }
};
...
if(false) {
	module.hot.accept("!!../../node_modules/css-loader/index.js!./threshold.css", function() {
		var newContent = require("!!../../node_modules/css-loader/index.js!./threshold.css");
...
// module
exports.push([module.i, "#injected-app > #injected-threshold {\n    background: rgba(255, 0, 0, 0.45);\n    width: 20px;\n    height: 100vh;\n    position: fixed;\n    right: 0;\n    top: 0;\n}\n\n\n\n", ""]);
